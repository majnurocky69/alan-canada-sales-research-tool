...
Aviron is a health, wellness & fitness technology company based in Toronto, Canada, founded in 2018. They are in their Series A funding stage, having secured a substantial $41.6M in total funding. With an annual revenue of $1M, Aviron is actively expanding its market presence, with products now available direct-to-consumer and through retail partners in regions including the UK, Europe, and Asia, signaling early growth and a focus on international reach.
...
- **Andy Hoang** • *Founder and CEO*
  ...
  - Email Schema/Status: Not Publicly Available

## 4. Referenced Deep Web Citations
- **APOLLO DEMOGRAPHICS**: Extracted employee count (68), location (Toronto, Ontario), industry (health, wellness & fitness), annual revenue ($1M), total funding ($41.6M), latest funding stage (Series A), and founded year (2018). ([Link](N/A))
- **Aviron 2026 Company Profile: Valuation, Funding & Investors (Pitchbook)**: Confirmed Aviron's headquarters in Toronto, Canada and employee count (67 total employees). ([Link](https://pitchbook.com/profiles/company/459127-90))
